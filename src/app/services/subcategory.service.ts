...
export class SubcategoriesService {
  ...
  public getAllSubcategories(): Observable<ISubcategory[]> {
    return this.db.collection<ISubcategory>(this.collection).valueChanges({idField:'id'})
  }

  public getSubcategoryById(id:string): Observable<ISubcategory> {
    return this.db.collection<ISubcategory>(this.collection).doc(id).valueChanges({idField:'id'})
  }

  public createSubcategory(subcategory: ISubcategory): Promise<DocumentReference<ISubcategory>> {
  ...
  public updateSubcategory(subcategory: ISubcategory): Promise<void> {
    return this.db.collection(this.collection).doc(subcategory.id).update(subcategory)
  }
